...
module.exports =  class Crypto{
    privateKey = "HVXNGTIYS11VY7MK";//process.env.ENCRYPT_KEY;

    // AESEncrypt(data){
    //     var ciphertext = encodeURIComponent(CryptoJS.AES.encrypt(JSON.stringify(data), this.privateKey).toString());    
    //     return ciphertext;
    // }

    // AESDecrypt(data){
    //     var bytes  = CryptoJS.AES.decrypt(decodeURIComponent(data), this.privateKey);
