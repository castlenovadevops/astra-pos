...
export default class Customer extends React.Component{
    ...
    getActions(params){
        ...
        return <div>       
                {(checkButtonAccess('Customer') !== 'W' && userdetail.mEmployeeRoleName!=='Owner') && <div style={{margin:'0 8px'}}>N/A</div>}
                {(checkButtonAccess('Customer') === 'W' || userdetail.mEmployeeRoleName==='Owner') && <FButton  permission_id = "web_edit_customer" permission_label="Show edit customer"
                variant="outlined" 
                size="small" 
        ...
        return <Page title="Customer | Astro POS">
            ...
            {!this.state.addForm ? 
                ...
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                    ...
                    {checkButtonAccess('Customer') === 'W' && <FButton 
