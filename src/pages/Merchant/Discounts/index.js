    ...
    getActions(params){
        ...
        return <div>       
               ...
               {(userdetail.userRole === 'Admin' || userdetail.userRole==='Owner') &&  <FButton
                ...
                {(userdetail.userRole === 'Admin' || userdetail.userRole==='Owner') && params.row.mDiscountStatus==='1' &&
                    <FButton
                    variant="contained" 
                    size="small" 
                ...
                {(userdetail.userRole === 'Admin'  || userdetail.userRole==='Owner') && params.row.mDiscountStatus==='0'  &&
                    <FButton
                    variant="contained" 
                    size="small" 
