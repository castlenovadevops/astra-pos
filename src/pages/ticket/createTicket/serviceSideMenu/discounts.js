...
export default class DiscountsListComponent extends React.Component{
    ...
    render(){
        ...
        {this.state.discountsList.map((dis) => (   
                ...
                style={{border:'2px solid #e0e0e0',display:'flex',maxHeight:'70px', padding: '10px',margin: '10px',maxWidth: '40%',height: '70px', background: this.isDiscountCheck(dis.mDiscountId) ? '#bee1f7':'transparent',
