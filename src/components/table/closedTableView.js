...
import { IconButton, TextField,Stack, Button, Dialog, DialogActions, DialogContent, DialogContentText, Grid, DialogTitle } from '@mui/material';
        ...
        <DataGrid
          ...
          componentsProps={{
            toolbar: {
              ...
              checkBatch: ()=> this.props.tblFunctions.checkBatch(),
              openClosedDatePopup :()=>{console.log(this.props); this.props.tblFunctions.openClosedDatePopup()}
            }
